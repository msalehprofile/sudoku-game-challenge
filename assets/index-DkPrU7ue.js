(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const I of document.querySelectorAll('link[rel="modulepreload"]'))e(I);new MutationObserver(I=>{for(const i of I)if(i.type==="childList")for(const t of i.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&e(t)}).observe(document,{childList:!0,subtree:!0});function H(I){const i={};return I.integrity&&(i.integrity=I.integrity),I.referrerPolicy&&(i.referrerPolicy=I.referrerPolicy),I.crossOrigin==="use-credentials"?i.credentials="include":I.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function e(I){if(I.ep)return;I.ep=!0;const i=H(I);fetch(I.href,i)}})();const G=`<selection class="screen__edit">
