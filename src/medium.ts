export const renderMedium = 
    ...
    <div class="grid__box">
        ...
        <div id="11" class="L3 R3 B1 grid__box__no">1</div>
    </div>

    <div class="grid__box">
        <div id="25" class="L1 R4 B2 grid__box__no">5</div>
        <div id="23" class="L1 R5 B2 grid__box__no">3</div>
        <div id="21" class="L1 R6 B2 grid__box__no">1</div>
        <div id="26" class="L2 R4 B2 grid__box__no"></div>
        <div id="24" class="L2 R5 B2 grid__box__no">4</div>
        <div id="29" class="L2 R6 B2 grid__box__no">9</div>
        <div id="28" class="L3 R4 B2 grid__box__no">8</div>
        <div id="22" class="L3 R5 B2 grid__box__no"></div>
        <div id="27" class="L3 R6 B2 grid__box__no">7</div>
    </div>
    ...
    <div class="grid__box">
        ...
        <div id="33" class="L2 R7 B3 grid__box__no">3</div>
        <div id="38" class="L2 R8 B3 grid__box__no">8</div>
        <div id="31" class="L2 R9 B3 grid__box__no"></div>
        <div id="34" class="L3 R7 B3 grid__box__no"></div>
        <div id="35" class="L3 R8 B3 grid__box__no">5</div>
        <div id="39" class="L3 R9 B3 grid__box__no">9</div>
    </div>

    <div class="grid__box">
        <div id="47" class="L4 R1 B4 grid__box__no">7</div>
        <div id="45" class="L4 R2 B4 grid__box__no"></div>
        <div id="44" class="L4 R3 B4 grid__box__no">4</div>
        <div id="48" class="L5 R1 B4 grid__box__no"></div>
        <div id="42" class="L5 R2 B4 grid__box__no"></div>
        <div id="43" class="L5 R3 B4 grid__box__no">3</div>
        <div id="41" class="L6 R1 B4 grid__box__no"></div>
        <div id="46" class="L6 R2 B4 grid__box__no">6</div>
        <div id="49" class="L6 R3 B4 grid__box__no">9</div>
    </div>

    <div class="grid__box">
        <div id="52" class="L4 R4 B5 grid__box__no">2</div>
        ...
        <div id="59" class="L5 R5 B5 grid__box__no">9</div>
    ...
    <div class="grid__box">
        ...
        <div id="66" class="L4 R9 B6 grid__box__no">6</div>
        <div id="65" class="L5 R7 B6 grid__box__no"></div>
        <div id="61" class="L5 R8 B6 grid__box__no"></div>
        <div id="67" class="L5 R9 B6 grid__box__no">7</div>
    ...
    <div class="grid__box">
        ...
        <div id="77" class="L7 R3 B7 grid__box__no">7</div>
        <div id="74" class="L8 R1 B7 grid__box__no"></div>
        <div id="79" class="L8 R2 B7 grid__box__no">9</div>
        <div id="72" class="L8 R3 B7 grid__box__no">2</div>
        <div id="75" class="L9 R1 B7 grid__box__no">5</div>
        <div id="71" class="L9 R2 B7 grid__box__no">1</div>
    ...
    <div class="grid__box">
        ...
        <div id="88" class="L9 R6 B8 grid__box__no">4</div>
    </div>
    ...
    <div class="grid__box">
        ...
        <div id="97" class="L8 R8 B9 grid__box__no">7</div>
        ...
        <div id="98" class="L9 R9 B9 grid__box__no">8</div>
    </div>
    </main>
